...
module.exports.config = {
    ...
    version: "2.0.1",
    hasPermssion: 0,
     credits: "Bareno", // Data mine by Q.Cường, cũng chỉ là thay xíu th nên k bán
...
module.exports.onLoad = async () => {
    ...
    const dirCache = __dirname + `/game/mine/cache/`;
...
module.exports.image = async function(link) {
    ...
    let download = (await axios.get(link, { responseType: "arraybuffer" } )).data; 
        fs.writeFileSync( __dirname + `/game/mine/cache/minecraft.png`, Buffer.from(download, "utf-8"));
        images.push(fs.createReadStream(__dirname + `/game/mine/cache/minecraft.png`));
    return images
}
